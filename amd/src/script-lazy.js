...
define(['jquery'], function ($)
{
     ...
     *  @return {String}
     */
    get_action_url = function(name, args)
    {
     ...
     */
    setCookie = function(name, value, expireTimeInMillisecond)
    {
        var d = new Date();
     ...
     */
    create_command = function(name, pix)
    {
     ...
     *  @param {String} [pix] The icon pix name to override
     */
    create_special_activity_command = function(name, pix)
    {
        return $('<a href="javascript:void(0)"/>')
            .addClass(icon[name].css)
     ...
     *  @param {Boolean} userdata
     */
    backup_section = function(sectionID, userdata)
    {
    ...
    add_backup_comand = function($activity)
    {
    ...
    var init = function()
    {
        console.log("sharing cart init");
        M.str.block_sharing_cart['pluginname'] = get_plugin_name();
    ...
    var reinit_activity_commands = function(section){
        ...
        var $menu = $(section).find("div[role='menu']").first();
    ...
    return {
        init: init,
        reinit_activity_commands : reinit_activity_commands
    };
});